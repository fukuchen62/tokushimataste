                ...
                <form id="search-box" method="GET" action="<?php /*echo home_url('/')*/ ?>">
                    ...
                    <section class="inner_search">
                        ...
                        <ul>
                            ...
                            <li><input type="checkbox" name="otomoType" id="otomoType2" value="佃煮・海産物">
                                <label for="otomoType2">佃煮・海産物</label>
                            </li>
                            <li><input type="checkbox" name="otomoType" id="otomoType3" value="肉・卵・大豆製品">
                                <label for="otomoType3">肉・卵・大豆製品</label>
                            </li>
                            <li><input type="checkbox" name="otomoType" id="otomoType4" value="ふりかけ・混ぜご飯の素">
                                <label for="otomoType4">ふりかけ・混ぜご飯の素</label>
                            </li>
                            <li><input type="checkbox" name="otomoType" id="otomoType5" value="薬味・シンプル調味料">
                                <label for="otomoType5">薬味・シンプル調味料</label>
                            </li>
                            <li><input type="checkbox" name="otomoType" id="otomoType6" value="その他">
                    ...
                    <section class="inner_search">
                        ...
                        <ul>
                            ...
                            <li><input type="checkbox" name="taste" id="taste2" value="辛い">
                                <label for="taste2">辛い</label>
                            </li>
                            <li><input type="checkbox" name="taste" id="taste3" value="塩辛い">
                                <label for="taste3">塩辛い</label>
                            </li>
                            <li><input type="checkbox" name="taste" id="taste4" value="苦い">
                                <label for="taste4">苦い</label>
                            </li>
                            <li><input type="checkbox" name="taste" id="taste5" value="うま味">
                    ...
                    <section class="inner_search">
                        ...
                        <ul>
                            ...
                            <li><input type="checkbox" name="allergy" id="allergy2" value="かに">
                                <label for="allergy2">かに</label>
                            </li>
                            <li><input type="checkbox" name="allergy" id="allergy3" value="クルミ">
                                <label for="allergy3">くるみ</label>
                            </li>
                            <li><input type="checkbox" name="allergy" id="allergy4" value="小麦">
                                <label for="allergy4">小麦</label>
                            </li>
                            <li><input type="checkbox" name="allergy" id="allergy5" value="そば">
                                <label for="allergy5">そば</label>
                            </li>
                            <li><input type="checkbox" name="allergy" id="allergy6" value="卵">
                                <label for="allergy6">卵</label>
                            </li>
                            <li><input type="checkbox" name="allergy" id="allergy7" value="乳">
